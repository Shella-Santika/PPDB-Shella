      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="pem">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="transksi.php">Transaksi</a></li>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <button type="button" class="btn btn" style="background-color:grey;color:white;" data-toggle="modal" data-target="#exampleModalScrollable">
